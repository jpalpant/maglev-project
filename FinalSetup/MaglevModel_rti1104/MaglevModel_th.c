/************************ dSPACE target specific file *************************
   ...
   Include file .\maglevmodel_rti1104\MaglevModel_th.c :

   Task Configuration file for model : MaglevModel
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\maglevmodel_rti1104\MaglevModel_th.c is for ST).
# endif
