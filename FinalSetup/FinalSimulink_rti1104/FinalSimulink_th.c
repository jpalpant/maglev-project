/************************ dSPACE target specific file *************************
   ...
   Include file .\finalsimulink_rti1104\FinalSimulink_th.c :

   Task Configuration file for model : FinalSimulink

   RTI1104 6.6 (29-Nov-2010)/2.3
   03-Dec-2014 14:35:15
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\finalsimulink_rti1104\FinalSimulink_th.c is for ST).
# endif
