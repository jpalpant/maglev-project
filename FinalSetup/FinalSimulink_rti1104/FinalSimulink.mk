...
#
#  $RCSfile: FinalSimulink.mk $ $Revision: 2.40 $ $Date: 2010/06/17 13:44:29CEST $
...
COMPUTER                       = PCWIN
MODEL                          = FinalSimulink
MODULES                        = FinalSimulink_data.c FinalSimulink_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_pow_snf.c 
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 2
...
RTWCUST_INCLUDES = \
	$(START_DIR)\FinalSimulink_rti1104 \
	$(START_DIR)
