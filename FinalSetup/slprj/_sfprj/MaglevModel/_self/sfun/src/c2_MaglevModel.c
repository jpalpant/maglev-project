...
static void initialize_c2_MaglevModel(SFc2_MaglevModelInstanceStruct
  *chartInstance);
static void initialize_params_c2_MaglevModel(SFc2_MaglevModelInstanceStruct
  *chartInstance);
static void enable_c2_MaglevModel(SFc2_MaglevModelInstanceStruct *chartInstance);
static void disable_c2_MaglevModel(SFc2_MaglevModelInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_MaglevModel
  (SFc2_MaglevModelInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_MaglevModel
  (SFc2_MaglevModelInstanceStruct *chartInstance);
static void set_sim_state_c2_MaglevModel(SFc2_MaglevModelInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_MaglevModel(SFc2_MaglevModelInstanceStruct
  *chartInstance);
static void sf_c2_MaglevModel(SFc2_MaglevModelInstanceStruct *chartInstance);
static void compInitSubchartSimstructsFcn_c2_MaglevModel
  (SFc2_MaglevModelInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static void c2_eml_scalar_eg(SFc2_MaglevModelInstanceStruct *chartInstance);
static real_T c2_rand(SFc2_MaglevModelInstanceStruct *chartInstance);
static void c2_eml_rand_mt19937ar(SFc2_MaglevModelInstanceStruct *chartInstance,
  uint32_T c2_state[625]);
static void c2_b_eml_rand_mt19937ar(SFc2_MaglevModelInstanceStruct
...
static real_T c2_emlrt_marshallIn(SFc2_MaglevModelInstanceStruct *chartInstance,
  const mxArray *c2_n, const char_T *c2_name);
static uint8_T c2_b_emlrt_marshallIn(SFc2_MaglevModelInstanceStruct
  *chartInstance, const mxArray *c2_b_method, const char_T *c2_name);
static real_T c2_c_emlrt_marshallIn(SFc2_MaglevModelInstanceStruct
  *chartInstance, const mxArray *c2_b_ni, const char_T *c2_name);
static void c2_d_emlrt_marshallIn(SFc2_MaglevModelInstanceStruct *chartInstance,
  const mxArray *c2_b_twister_state, const char_T *c2_name, uint32_T c2_y[625]);
static uint32_T c2_e_emlrt_marshallIn(SFc2_MaglevModelInstanceStruct
  *chartInstance, const mxArray *c2_b_v4_state, const char_T *c2_name);
static uint8_T c2_f_emlrt_marshallIn(SFc2_MaglevModelInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_MaglevModel, const char_T
  *c2_name);
static void init_dsm_address_info(SFc2_MaglevModelInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_MaglevModel = 0U;
}
  ...
  (SFc2_MaglevModelInstanceStruct *chartInstance)
{
  ...
  c2_f_hoistedGlobal = chartInstance->c2_is_active_c2_MaglevModel;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_n = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 0)),
  ...
  chartInstance->c2_is_active_c2_MaglevModel = c2_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 5)),
     "is_active_c2_MaglevModel");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_MaglevModel(chartInstance);
...
static const mxArray *c2_sf_marshall(void *chartInstanceVoid, void *c2_u)
{
  ...
  const mxArray *c2_b_y = NULL;
  SFc2_MaglevModelInstanceStruct *chartInstance;
  chartInstance = (SFc2_MaglevModelInstanceStruct *)chartInstanceVoid;
  c2_y = NULL;
  c2_b_u = *((real_T *)c2_u);
  c2_b_y = NULL;
  if (!chartInstance->c2_ni_not_empty) {
...
const mxArray *sf_c2_MaglevModel_get_eml_resolved_functions_info(void)
{
...
static uint8_T c2_f_emlrt_marshallIn(SFc2_MaglevModelInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_MaglevModel,
  const char_T *c2_name)
{
  uint8_T c2_y;
  uint8_T c2_u4;
  sf_mex_import(c2_name, sf_mex_dup(c2_b_is_active_c2_MaglevModel), &c2_u4, 1, 3,
                0U, 0, 0U, 0);
  c2_y = c2_u4;
  sf_mex_destroy(&c2_b_is_active_c2_MaglevModel);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_MaglevModel_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_MaglevModel_get_autoinheritance_info(void)
{
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_MaglevModelInstanceStruct *chartInstance;
    chartInstance = (SFc2_MaglevModelInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c2_MaglevModel(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_MaglevModelInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c2_MaglevModel((SFc2_MaglevModelInstanceStruct*)
    chartInstanceVar);
  initialize_c2_MaglevModel((SFc2_MaglevModelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_MaglevModel(void *chartInstanceVar)
{
  enable_c2_MaglevModel((SFc2_MaglevModelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_MaglevModel(void *chartInstanceVar)
{
  disable_c2_MaglevModel((SFc2_MaglevModelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_MaglevModel(void *chartInstanceVar)
{
  sf_c2_MaglevModel((SFc2_MaglevModelInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c2_MaglevModel(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_MaglevModel
    ((SFc2_MaglevModelInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c2_MaglevModel();/* state var info */
...
static void sf_internal_set_sim_state_c2_MaglevModel(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_MaglevModel();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c2_MaglevModel((SFc2_MaglevModelInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c2_MaglevModel(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_MaglevModel(S);
}

static void sf_opaque_set_sim_state_c2_MaglevModel(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c2_MaglevModel(S, st);
}

static void sf_opaque_terminate_c2_MaglevModel(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_MaglevModelInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_MaglevModel((SFc2_MaglevModelInstanceStruct*) chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c2_MaglevModel((SFc2_MaglevModelInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_MaglevModel(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_MaglevModel(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"MaglevModel","MaglevModel",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"MaglevModel","MaglevModel",2,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"MaglevModel",
      "MaglevModel",2,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"MaglevModel","MaglevModel",2,1);
      sf_mark_chart_reusable_outputs(S,"MaglevModel","MaglevModel",2,1);
    }

    sf_set_rtw_dwork_info(S,"MaglevModel","MaglevModel",2);
...
static void mdlRTW_c2_MaglevModel(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "MaglevModel", "MaglevModel",2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c2_MaglevModel(SimStruct *S)
{
  SFc2_MaglevModelInstanceStruct *chartInstance;
  chartInstance = (SFc2_MaglevModelInstanceStruct *)malloc(sizeof
    (SFc2_MaglevModelInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_MaglevModelInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_MaglevModel;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_MaglevModel;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_MaglevModel;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_MaglevModel;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_MaglevModel;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_MaglevModel;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_MaglevModel;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_MaglevModel;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_MaglevModel;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_MaglevModel;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_MaglevModel;
...
void c2_MaglevModel_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_MaglevModel(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_MaglevModel(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_MaglevModel(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_MaglevModel_method_dispatcher.\n"
