...
static void initialize_c3_FinalSimulink(SFc3_FinalSimulinkInstanceStruct
  *chartInstance);
static void initialize_params_c3_FinalSimulink(SFc3_FinalSimulinkInstanceStruct *
  chartInstance);
static void enable_c3_FinalSimulink(SFc3_FinalSimulinkInstanceStruct
  *chartInstance);
static void disable_c3_FinalSimulink(SFc3_FinalSimulinkInstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_FinalSimulink
  (SFc3_FinalSimulinkInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_FinalSimulink
  (SFc3_FinalSimulinkInstanceStruct *chartInstance);
static void set_sim_state_c3_FinalSimulink(SFc3_FinalSimulinkInstanceStruct
  *chartInstance, const mxArray *c3_st);
static void finalize_c3_FinalSimulink(SFc3_FinalSimulinkInstanceStruct
  *chartInstance);
static void sf_c3_FinalSimulink(SFc3_FinalSimulinkInstanceStruct *chartInstance);
static void compInitSubchartSimstructsFcn_c3_FinalSimulink
  (SFc3_FinalSimulinkInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static void c3_eml_error(SFc3_FinalSimulinkInstanceStruct *chartInstance);
...
static real_T c3_emlrt_marshallIn(SFc3_FinalSimulinkInstanceStruct
  *chartInstance, const mxArray *c3_n, const char_T *c3_name);
static uint8_T c3_b_emlrt_marshallIn(SFc3_FinalSimulinkInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_FinalSimulink, const char_T
  *c3_name);
static void init_dsm_address_info(SFc3_FinalSimulinkInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_FinalSimulink = 0U;
}
  ...
  (SFc3_FinalSimulinkInstanceStruct *chartInstance)
{
  ...
  c3_b_hoistedGlobal = chartInstance->c3_is_active_c3_FinalSimulink;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_n = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 0)),
    "n");
  chartInstance->c3_is_active_c3_FinalSimulink = c3_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
     "is_active_c3_FinalSimulink");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_FinalSimulink(chartInstance);
...
static const mxArray *c3_sf_marshall(void *chartInstanceVoid, void *c3_u)
{
  ...
  const mxArray *c3_b_y = NULL;
  SFc3_FinalSimulinkInstanceStruct *chartInstance;
  chartInstance = (SFc3_FinalSimulinkInstanceStruct *)chartInstanceVoid;
  c3_y = NULL;
  c3_b_u = *((real_T *)c3_u);
  c3_b_y = NULL;
...
const mxArray *sf_c3_FinalSimulink_get_eml_resolved_functions_info(void)
{
...
static uint8_T c3_b_emlrt_marshallIn(SFc3_FinalSimulinkInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_FinalSimulink
  , const char_T *c3_name)
{
  uint8_T c3_y;
  uint8_T c3_u0;
  sf_mex_import(c3_name, sf_mex_dup(c3_b_is_active_c3_FinalSimulink), &c3_u0, 1,
                3, 0U, 0, 0U, 0);
  c3_y = c3_u0;
  sf_mex_destroy(&c3_b_is_active_c3_FinalSimulink);
  return c3_y;
}
...
/* SFunction Glue Code */
void sf_c3_FinalSimulink_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_FinalSimulink_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c3_FinalSimulink(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"n\",},{M[8],M[0],T\"is_active_c3_FinalSimulink\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_FinalSimulink_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_FinalSimulinkInstanceStruct *chartInstance;
    chartInstance = (SFc3_FinalSimulinkInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c3_FinalSimulink(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_FinalSimulinkInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_FinalSimulink((SFc3_FinalSimulinkInstanceStruct*)
    chartInstanceVar);
  initialize_c3_FinalSimulink((SFc3_FinalSimulinkInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_FinalSimulink(void *chartInstanceVar)
{
  enable_c3_FinalSimulink((SFc3_FinalSimulinkInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_FinalSimulink(void *chartInstanceVar)
{
  disable_c3_FinalSimulink((SFc3_FinalSimulinkInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_FinalSimulink(void *chartInstanceVar)
{
  sf_c3_FinalSimulink((SFc3_FinalSimulinkInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c3_FinalSimulink(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_FinalSimulink
    ((SFc3_FinalSimulinkInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c3_FinalSimulink();/* state var info */
...
static void sf_internal_set_sim_state_c3_FinalSimulink(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_FinalSimulink();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c3_FinalSimulink((SFc3_FinalSimulinkInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c3_FinalSimulink(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_FinalSimulink(S);
}

static void sf_opaque_set_sim_state_c3_FinalSimulink(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c3_FinalSimulink(S, st);
}

static void sf_opaque_terminate_c3_FinalSimulink(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_FinalSimulinkInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c3_FinalSimulink((SFc3_FinalSimulinkInstanceStruct*)
      chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c3_FinalSimulink
    ((SFc3_FinalSimulinkInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_FinalSimulink(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_FinalSimulink(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"FinalSimulink","FinalSimulink",3);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"FinalSimulink","FinalSimulink",3,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"FinalSimulink",
      "FinalSimulink",3,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"FinalSimulink","FinalSimulink",3,3);
      sf_mark_chart_reusable_outputs(S,"FinalSimulink","FinalSimulink",3,1);
    }

    sf_set_rtw_dwork_info(S,"FinalSimulink","FinalSimulink",3);
...
static void mdlRTW_c3_FinalSimulink(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "FinalSimulink", "FinalSimulink",3);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c3_FinalSimulink(SimStruct *S)
{
  SFc3_FinalSimulinkInstanceStruct *chartInstance;
  chartInstance = (SFc3_FinalSimulinkInstanceStruct *)malloc(sizeof
    (SFc3_FinalSimulinkInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_FinalSimulinkInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_FinalSimulink;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_FinalSimulink;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_FinalSimulink;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_FinalSimulink;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_FinalSimulink;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_FinalSimulink;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_FinalSimulink;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_FinalSimulink;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_FinalSimulink;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_FinalSimulink;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_FinalSimulink;
...
void c3_FinalSimulink_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_FinalSimulink(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_FinalSimulink(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_FinalSimulink(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_FinalSimulink_method_dispatcher.\n"
